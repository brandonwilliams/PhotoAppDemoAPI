<?php
  ...
  $router->get('/api/public/images', function() use ($app){
    header('Content-Type: application/json; charset=utf-8');
    ...
    if (
      ...
      $perPage = filter_var($_GET['perpage'], FILTER_SANITIZE_NUMBER_INT);
      echo json_encode($app->images($page, $perPage));
    } else {
      echo json_encode($app->images());
    }
